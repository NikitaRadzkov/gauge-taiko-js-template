...
# If you have Apple Silicon chip run this command
# 	docker build --platform linux/amd64 --no-cache -t gauge-taiko .
# Running the image
# 	docker run --rm -it -v ${PWD}/reports:/gauge/reports gauge-taiko
# If you have Apple Silicon chip run this command
#	docker run --platform linux/amd64 --rm -it -v ${PWD}/reports:/gauge/reports gauge-taiko
